...
2026-09-06 immutable release의 `72 revalidated evaluator runs`는 Knowledge·Tool-call·Agent-single·Agent-multi 4개 evaluator를 18개 모델에 다시 실행한 수입니다. Performance·Server-performance·Coding은 기존 정식 source run 54개를 재사용했으며, 해당 historical matrix의 source run reference는 126개입니다. 현재 projection에는 2026-09-10 N2.5 Mini 4개 variant의 28개 fresh full-cycle run과 2026-09-16 N2/N2.5 Mini 8개 variant의 외부 `tool-eval-bench` 실행 8개가 추가되어 총 23개 모델 변형·8개 suite·169개 source run reference가 있습니다.
